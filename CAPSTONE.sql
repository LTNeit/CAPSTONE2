...
(1, 5, 2, '2026-07-16 16:29:43', 'Ảnh này nét!!');
INSERT INTO `hinh_anh` (`hinh_id`, `ten_hinh`, `duong_dan`, `mo_ta`, `nguoi_dung_id`) VALUES
(2, '1.png', 'http://localhost:3069/users/5/posts/local-1784218840516-260117718.png', '', 5);
INSERT INTO `luu_anh` (`nguoi_dung_id`, `hinh_id`, `ngay_luu`) VALUES
(5, 2, '2026-07-16 16:45:02');
INSERT INTO `nguoi_dung` (`nguoi_dung_id`, `email`, `mat_khau`, `ho_ten`, `tuoi`, `anh_dai_dien`) VALUES
(5, 'hohoangtien@gmail.com', '$2b$10$OoBdUvGLXGMdN1iS5vBj..tNfCBYMqcZyhoZwvQGUfqoPeXV0TkB2', 'Hồ Hoàng Tiến', 23, NULL);
